...
set CLASSPATH=%APP_HOME%\jadx-cli-0.8.0.jar;%APP_HOME%\jadx-core-0.8.0.jar;%APP_HOME%\dx-1.14.jar;%APP_HOME%\android-5.1.jar;%APP_HOME%\logback-classic-1.2.3.jar;%APP_HOME%\slf4j-api-1.7.25.jar;%APP_HOME%\jcommander-1.74.jar;%APP_HOME%\commons-io-2.6.jar;%APP_HOME%\asm-6.2.jar;%APP_HOME%\annotations-16.0.2.jar;%APP_HOME%\cloning-1.9.10.jar;%APP_HOME%\logback-core-1.2.3.jar;%APP_HOME%\objenesis-2.6.jar
